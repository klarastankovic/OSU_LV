...
plot_decision_regions(X_train_n, y_train, classifier=knn_gscv.best_estimator_)
plt.xlabel('x_1')
plt.ylabel('x_2')
plt.legend(loc='upper left')
plt.title("K=" + str(knn_gscv.best_params_['n_neighbors']) + " Tocnost: " + "{:0.3f}".format(knn_gscv.best_score_))
plt.tight_layout()

plot_decision_regions(X_test_n, y_test, classifier=knn_gscv.best_estimator_)
plt.xlabel('x_1')
plt.ylabel('x_2')
plt.legend(loc='upper left')
plt.title("K=" + str(knn_gscv.best_params_['n_neighbors']) + " Tocnost test: " + "{:0.3f}".format(accuracy_score(y_test, knn_gscv.best_estimator_.predict(X_test_n))))
plt.tight_layout()
...
plt.title(f"Najbolji SVM: C={svm_gscv.best_params_['C']}, gamma={svm_gscv.best_params_['gamma']}\n"
          f"Tocnost train: {accuracy_score(y_train, best_svm.predict(X_train_n)):.3f}")
plt.legend(loc='upper left')
plt.tight_layout()

plot_decision_regions(X_test_n, y_test, classifier=best_svm)
plt.xlabel('x_1')
plt.ylabel('x_2')
plt.title(f"Najbolji SVM: C={svm_gscv.best_params_['C']}, gamma={svm_gscv.best_params_['gamma']}\n"
          f"Tocnost test: {accuracy_score(y_test, y_test_p_best):.3f}")
plt.legend(loc='upper left')
plt.tight_layout()
